...
#define NSA 3
	...
	int last_rtt_;		/* more recent RTT measurement in ms, */
				/*   for statistics only */
  double rwnd_;		/*added by zhj on 2011-11-6, for rwnd feedback*/
  //ws: added for DSAB
  int DSAB_type_;
  int DSAB_SYN_FIN_;
...
#define DSAB_STATE_SEND_RR 0x01
#define DSAB_STATE_SEND_BC 0x02
#define DSAB_STATE_SEND_RW 0x03
#define DSAB_STATE_SEND_NOTHING 0x04
#define DSAB_STATE_WAIT_RW 0x05
#define DSAB_STATE_CLOSE 0x06
...
//ws: added for D2TCP
#define CLOSE_SSTHRESH_D2TCP    0x00100000
#define CLOSE_CWND_D2TCP        0x00200000
...
protected:
	...
	int d2tcp_;
	double d2tcp_gamma_;
	double d2tcp_deadline_;
	double d2tcp_total_bytes_;
